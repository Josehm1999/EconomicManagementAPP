...
namespace EconomicManagementAPP.Services
{
      ...
      IUserPasswordStore<Users>
    {
        ...
        {
            user.Id = await _repositorieUsers.Create(user);
        ...
        {
            return await _repositorieUsers.GetUserByEmail(normalizedEmail);
        }
        ...
        {
            return await _repositorieUsers.GetUserByEmail(normalizedUserName);
        }
