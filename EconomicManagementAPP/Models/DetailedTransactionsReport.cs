namespace EconomicManagementAPP.Models
{
    public class DetailedTransactionsReport
    {
        ...
        public decimal WithdrawalsBalance => GroupedTransactions.Sum(x => x.WithdrawalsBalace);
        ...
        public class TransactionsByDate
        {
            ...
            public decimal WithdrawalsBalace => Transactions.Where(x => x.OperationTypesId == OperationTypes.Expenses)
                .Sum(y => y.Total);
